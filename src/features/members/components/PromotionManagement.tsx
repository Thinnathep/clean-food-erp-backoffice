...
const DEFAULT_TEMPLATES: SalesTemplate[] = [
  {
    ...
    category: 'greeting',
    label: 'ทักทายต้อนรับ',
    content: 'สวัสดีครับ/ค่ะ ยินดีต้อนรับสู่ Clean Food ครับ สนใจดูแลสุขภาพด้วยคอร์สอาหารคลีนเมนูไหนเป็นพิเศษไหมครับ?'
  },
  {
    id: 's1',
    category: 'selling',
    label: 'เสนอโปรฯ ยอดฮิต',
    content: 'ตอนนี้มีโปรโมชั่นแนะนำเป็นแพ็กเกจ 30 มื้อ ราคาพิเศษเพียง 1,799 บาท (ตกมื้อละ 60 บาทเท่านั้น!) ได้เมนูพรีเมียมครบถ้วนเลยครับ'
  },
  {
    id: 'd1',
    category: 'delivery',
    label: 'แจ้งรอบการส่ง',
    content: 'เราจัดส่งรอบเช้า 08:00 - 10:00 และรอบเย็น 15:00 - 17:00 ครับ ลูกค้าสามารถเลือกเวลาที่สะดวกรับได้เลยครับ'
  },
  {
    id: 'p1',
    category: 'payment',
    label: 'แจ้งเลขบัญชี',
    content: 'สามารถโอนชำระได้ที่: ธนาคารกสิกรไทย เลขที่บัญชี 000-0-00000-0 ชื่อบัญชี บจก. คลีนฟู้ด เออร์ลี่ ครับ'
  },
  {
    id: 'c1',
    category: 'closing',
    label: 'ปิดการขาย/ขอบคุณ',
    content: 'เรียบร้อยครับ บันทึกข้อมูลคอร์สของลูกค้าเข้าระบบแล้วครับ ขอบคุณที่ไว้วางใจให้เราดูแลสุขภาพนะครับ'
  }
];
...
ได้รับยอด ${totalPrice.toLocaleString()} บาทเรียบร้อยครับ ขอบคุณที่ไว้วางใจให้ Clean Food CR ดูแลโภชนาการครับ ทางร้านจะจัดเตรียมวัตถุดิบและเริ่มจัดส่งมื้อแรก ในวัน ${startDateFormatted} ช่วงเวลา ${customerInfo.deliverySlot} ครับ`;
  };
