    ...
    <div className="p-4 md:p-8 space-y-8 bg-slate-50/50 min-h-full">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
        ...
        <div className="grid grid-cols-2 gap-4 w-full md:w-auto">
           <div className="bg-white p-4 rounded-[1.5rem] shadow-sm border border-slate-100 flex items-center gap-4 min-w-[180px]">
           ...
           <div className={`p-4 rounded-[1.5rem] shadow-sm border flex items-center gap-4 min-w-[180px] transition-colors ${lowStockCount > 0 ? 'bg-red-50 border-red-100' : 'bg-white border-slate-100'}`}>
          ...
          <div className="bg-white rounded-[2.5rem] shadow-2xl w-full max-w-md overflow-hidden animate-scale-in border border-white/20">
            ...
            <form onSubmit={handleStockIn} className="p-8 space-y-6">
              <div className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <label className="block text-[10px] text-slate-400 uppercase tracking-widest mb-2 ml-1">จำนวนที่รับเข้า ({selectedItemForStockIn.storage_unit})</label>
                  ...
                  <div>
                    <label className="block text-[10px] text-slate-400 uppercase tracking-widest mb-2 ml-1">ราคาต่อหน่วย</label>
