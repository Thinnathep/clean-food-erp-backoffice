  ...
  return (
    <div className="space-y-4">
      ...
      <div className="space-y-1 bg-white p-4 rounded-3xl border border-slate-100 shadow-sm">
        ...
        >
          <option value="Tahoma" style={{ fontFamily: "Tahoma, sans-serif" }}>
            Tahoma (แนะนำ! ลายเส้นคมชัด)
          </option>
          <option
            value="MS Sans Serif"
            style={{ fontFamily: "MS Sans Serif, sans-serif" }}
          >
            MS Sans Serif (คลาสสิกสากล)
          </option>
          <option value="Sarabun" style={{ fontFamily: "Sarabun, sans-serif" }}>
            Sarabun (สารบรรณทางการ)
          </option>
          <option value="Prompt" style={{ fontFamily: "Prompt, sans-serif" }}>
            Prompt (โมเดิร์นทันสมัย)
          </option>
          <option
            value="Courier New"
            style={{ fontFamily: "Courier New, monospace" }}
          >
            Courier New (ตัวพิมพ์ดีด)
          </option>
        </select>
        <p className="text-[9px] text-slate-400 leading-normal pt-1.5 ml-0.5">
          *ระบบจัดการพิมพ์ใช้โหมดกราฟิกภาพความแม่นยำสูงโดยอัตโนมัติ
          สระและวรรณยุกต์ไทยจะถูกจัดเรียงตำแหน่งและวาดลง Canvas อย่างถูกต้อง
          ไร้ปัญหาสระลอยหรือพิมพ์ห่าง
        </p>
      </div>
      ...
      <div className="relative mx-auto max-w-[280px]">
        ...
        <div className="bg-white border border-slate-200/80 rounded-2xl pt-5 pb-6 px-5 shadow-lg text-slate-800 space-y-3 relative overflow-hidden transition-all duration-300">
          ...
          <div
            ...
            style={{
              fontFamily: `${thaiFont === "Courier New" ? "Courier New, monospace" : `${thaiFont}, sans-serif`}`,
            }}
          >
