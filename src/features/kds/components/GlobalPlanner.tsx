      ...
      <div className="px-6 py-4 border-b border-slate-200 flex justify-between items-center bg-slate-50 z-10">
        ...
        <div className="flex flex-col md:flex-row items-stretch gap-2">
          <button 
            ...
            className="px-6 py-2.5 bg-white border border-slate-200 text-slate-600 hover:text-emerald-600 hover:border-emerald-200 rounded-xl text-xs font-medium transition-all shadow-sm flex items-center justify-center"
          >
            วันนี้
          </button>
          <div className="flex flex-1 md:w-auto items-center justify-between bg-white border border-slate-200 rounded-xl p-1 shadow-sm">
